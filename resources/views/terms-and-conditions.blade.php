<x-layout title="Syarat dan Ketentuan">
    <div class="bg-light py-5">
        <div class="container">
            <div class="row mb-5">
                <div class="col">
                    <h1 class="poppins"><strong>Terms and Conditions</strong></h1>
                    <p>Welcome to Lokertas!</p>
                    <p>These terms and conditions outline the rules and regulations for the use of PT Lokertas
                        Indonesia's Website, located at lokertas.org.</p>
                    <p>By accessing this website we assume you accept these terms and conditions. Do not continue to
                        use Lokertas if you do not agree to take all of the terms and conditions stated on this
                        page.</p>
                    ...
                    <p>We employ the use of cookies. By accessing Lokertas, you agreed to use cookies in agreement
                        with the PT Lokertas Indonesia's Privacy Policy. </p>
                    ...
                    <p>Unless otherwise stated, PT Lokertas Indonesia and/or its licensors own the intellectual
                        property rights for all material on Lokertas. All intellectual property rights are reserved.
                        You may access this from Lokertas for your own personal use subjected to restrictions set in
                        these terms and conditions.</p>
                    <p>You must not:</p>
                    <ul>
                        <li>Republish material from Lokertas</li>
                        <li>Sell, rent or sub-license material from Lokertas</li>
                        <li>Reproduce, duplicate or copy material from Lokertas</li>
                        <li>Redistribute content from Lokertas</li>
                    </ul>
                    <p>This Agreement shall begin on the date hereof. Our Terms and Conditions were created with the
                        help of the <a href="https://www.termsfeed.com/terms-conditions-generator/">Terms And
                            Conditions Generator</a>.</p>
                    <p>Parts of this website offer an opportunity for users to post and exchange opinions and
                        information in certain areas of the website. PT Lokertas Indonesia does not filter, edit,
                        publish or review Comments prior to their presence on the website. Comments do not reflect
                        the views and opinions of PT Lokertas Indonesia,its agents and/or affiliates. Comments
                        reflect the views and opinions of the person who post their views and opinions. To the
                        extent permitted by applicable laws, PT Lokertas Indonesia shall not be liable for the
                    ...
                    <p>PT Lokertas Indonesia reserves the right to monitor all Comments and to remove any Comments
                    ...
                    <p>You hereby grant PT Lokertas Indonesia a non-exclusive license to use, reproduce, edit and
                    ...
                    <p>We will approve link requests from these organizations if we decide that: (a) the link would
                        ...
                        visibility of the hyperlink compensates the absence of PT Lokertas Indonesia; and (d) the
                    ...
                    <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking
                        to our website, you must inform us by sending an e-mail to PT Lokertas Indonesia. Please
                    ...
                    <p>No use of PT Lokertas Indonesia's logo or other artwork will be allowed for linking absent a
