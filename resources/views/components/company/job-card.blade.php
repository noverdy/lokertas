<div class="d-flex align-items-center justify-content-between py-4 px-5 bg-white rounded shadow hover-rise mb-4">
    <div class="d-flex">
        <div class="me-md-5">
        ...
        <div>
            <h2 class="fs-2 fw-bold montserrat">{{ $vacancy->title }}</h2>
    ...
    <div>
        <a href="/vacancy/{{ $vacancy->id }}" class="btn btn-orange">Lihat Pelamar</a>
    </div>
</div>
