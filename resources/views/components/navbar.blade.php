    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link {{ request()->segment(1) === 'vacancy' ? 'active' : '' }}"
                        href="/vacancy">Lowongan</a>
                </li>
                {{-- <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->segment(1) === 'company' ? 'active' : '' }}"
                        href="/company">Perusahaan</a>
                </li>
                <li class="nav-item">
            ...
            @auth
                <div class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="/documents">Berkas Anda</a></li>
                        <li>
